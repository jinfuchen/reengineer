...
\textbf{Commit-level change measures.} As it is shown in Table~\ref{tab:subject}, we consider 12 change measures grouped into five dimensions according to their features.
\begin{enumerate}[(i)]
	\item \noindent
