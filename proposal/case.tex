...
\textbf{Model evaluation.} We utilize three metrics to evaluate classifier performance, including \emph{precision}, \emph{recall}. It depends on confusion matrix which contains four terms consisting of \emph{true positives, true negatives, false positives and false negatives}. 
